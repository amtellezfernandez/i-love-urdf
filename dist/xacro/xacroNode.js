...
exports.expandFetchedGitHubRepositoryXacro = exports.expandGitHubRepositoryXacro = exports.expandLocalXacroToUrdf = exports.buildXacroExpandPayloadFromRepository = exports.expandXacroRequestPayload = exports.setupXacroRuntime = exports.probeXacroRuntime = exports.MANAGED_XACRO_RUNTIME_PACKAGES = void 0;
...
exports.MANAGED_XACRO_RUNTIME_PACKAGES = Object.freeze(["xacro==2.1.1", "PyYAML==6.0.3"]);
...
const buildManagedXacroRuntimeInstallArgs = () => [
    "-I",
    "-m",
    "pip",
    "install",
    ...
    "--upgrade-strategy",
    "only-if-needed",
    ...exports.MANAGED_XACRO_RUNTIME_PACKAGES,
];
