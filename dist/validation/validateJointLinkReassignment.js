...
exports.validateJointLinkReassignment = void 0;
const urdfParser_1 = require("../parsing/urdfParser");
const validateJointLinkReassignment = (urdfContent, jointName, parentLink, childLink) => {
    if (!urdfContent.trim()) {
...
exports.validateJointLinkReassignment = validateJointLinkReassignment;
