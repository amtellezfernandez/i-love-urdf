...
exports.computeMeshBoundsFromArrayBuffer = computeMeshBoundsFromArrayBuffer;
...
const buildMeshBounds = (vertices) => {
...
const isBinaryStlArrayBuffer = (arrayBuffer) => {
...
const computeBinaryStlBoundsFromArrayBuffer = (arrayBuffer, scale) => {
...
const computeAsciiStlBoundsFromArrayBuffer = (arrayBuffer, scale) => {
...
function computeMeshBoundsFromArrayBuffer(arrayBuffer, scale = "1 1 1") {
    const scaleVec = parseScale(scale);
    return (computeBinaryStlBoundsFromArrayBuffer(arrayBuffer, scaleVec) ??
