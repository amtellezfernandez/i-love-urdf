import type { AutoPreviewPanel, CandidatePickerState, RepoIntentPromptState, ShellContextRow, ShellFeedbackKind, ShellOutputPanel } from "./cliShellTypes";
...
export declare const printRepoIntentPrompt: (prompt: RepoIntentPromptState, entries: readonly {
    name: string;
    summary: string;
}[]) => void;
