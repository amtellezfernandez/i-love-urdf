...
exports.CLI_HELP_SECTIONS = exports.TASK_FAMILIES = exports.COMMAND_USAGE_BY_NAME = exports.SUPPORTED_COMMANDS = exports.COMMAND_CATALOG = void 0;
...
exports.SUPPORTED_COMMANDS = Object.keys(exports.COMMAND_CATALOG);
exports.COMMAND_USAGE_BY_NAME = exports.SUPPORTED_COMMANDS.reduce((usageByName, commandName) => {
    usageByName[commandName] = exports.COMMAND_CATALOG[commandName].usage;
    return usageByName;
}, {});
const getCommandsForSection = (sectionKey) => exports.SUPPORTED_COMMANDS.filter((commandName) => exports.COMMAND_CATALOG[commandName].sections.some((section) => section === sectionKey));
exports.TASK_FAMILIES = TASK_FAMILY_ORDER.map((key) => ({
    key,
    ...TASK_FAMILY_METADATA[key],
    commands: getCommandsForSection(key),
}));
exports.CLI_HELP_SECTIONS = [
    ...exports.TASK_FAMILIES,
