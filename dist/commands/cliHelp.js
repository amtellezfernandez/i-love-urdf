...
const renderHelp = (options = {}) => {
    ...
    return [
        ...
        "",
        formatBlock("Shell", ["ilu", "ilu shell", "Paste owner/repo or drop a local path directly to start. ilu auto-loads the source and runs validation plus a health check when it can. Use / when you want extra helpers like /check, /convert, /fix, /open, or /inspect. Use /show to inspect the current flow, /update for latest, and Ctrl+C to quit."], theme),
        "",
