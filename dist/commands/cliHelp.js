...
const renderHelp = (options = {}) => {
    ...
    return [
        ...
        "",
        formatBlock("Shell", ["ilu", "ilu shell", "Paste owner/repo or drop a local path directly to start. Use / when you want extra helpers like /check, /convert, /fix, /open, or /inspect. Use /show to inspect the current flow, /update for latest, and Ctrl+C to quit."], theme),
        "",
