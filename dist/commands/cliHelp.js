...
exports.renderResumeHelp = exports.renderAttachHelp = exports.printHelp = exports.renderHelp = void 0;
...
const renderAttachHelp = (options = {}) => {
    const theme = createTheme(options.colorEnabled ?? resolveColorSupport());
    return [
...
exports.renderAttachHelp = renderAttachHelp;
const renderResumeHelp = (options = {}) => {
    const theme = createTheme(options.colorEnabled ?? resolveColorSupport());
    return [
...
exports.renderResumeHelp = renderResumeHelp;
