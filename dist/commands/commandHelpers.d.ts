...
export type CliCommandHelpers = {
    ...
    getNumericKeyValueArg: (args: CliArgMap, primaryKey: string, fallbackKey?: string) => Record<string, number>;
    parseTripletArg: (raw: string, label: string) => [number, number, number];
    getAxisSpecArg: (args: CliArgMap, key: string) => "x" | "y" | "z" | "+x" | "+y" | "+z" | "-x" | "-y" | "-z" | undefined;
