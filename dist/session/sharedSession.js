...
const applySharedSessionSnapshotToState = (state, snapshot, options = {}) => {
    ...
    state.loadedSource = snapshot.loadedSource
        ? {
            ...
            extractedArchivePath: snapshot.loadedSource.extractedArchivePath,
...
const getSharedSessionLoadedSource = (state) => {
    ...
    return loadedSource
        ? {
            ...
            extractedArchivePath: loadedSource.extractedArchivePath,
...
const buildStudioSessionUrl = (sessionId, options = {}) => {
